...
void CFireBall::Render()
{
	...
	if (vx > 0) ani = CAnimations::GetInstance()->Get(1101);
	else ani = CAnimations::GetInstance()->Get(1101);
...
CFireBall::CFireBall(float x, float y, float vx, float vy, float nx) :CGameObject(x, y)
{
	this->vx = vx;
	this->vy = vy;
	this->nx = nx;
