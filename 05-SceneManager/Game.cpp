...
void CGame::_ParseSection_SCENES(string line) //add each scene into list of scenes
{
	vector<string> tokens = split(line);
...
void CGame::Load(LPCWSTR gameFile)
{
	...
	while (f.getline(str, MAX_GAME_LINE))
	{
		...
		case GAME_FILE_SECTION_SCENES: _ParseSection_SCENES(line); break;//change the currentscene vaiable
