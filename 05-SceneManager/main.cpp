...
#define BACKGROUND_COLOR D3DXCOLOR(170.0f/255, 255.0f/255, 255.0f/255, 0.0)
...
int WINAPI WinMain(
	...
	LPGAME game = CGame::GetInstance();//get game instance
	game->Init(hWnd, hInstance);//somethings to do with window
	game->InitKeyboard();//init a keyboard to use 
