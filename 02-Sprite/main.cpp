...
CEnemy* gumpa;
#define GUMPA_START_X 200.0f
#define GUMPA_START_Y 134.0f
#define GUMPA_START_VX -0.1f
...
void LoadResources()
{
	...
	sprites->Add(30001, 4, 12, 21, 30, texEnemy);
	sprites->Add(30002, 24, 12, 42, 30, texEnemy);
	...
	sprites->Add(20002, 317, 117, 335, 132, texMisc);
	sprites->Add(20003, 336, 117, 353, 132, texMisc);
	sprites->Add(20004, 354, 117, 371, 132, texMisc);
	...
	sprites->Add(20005, 300, 135, 315, 150, texMisc);
	sprites->Add(20006, 317, 135, 335, 150, texMisc);
	sprites->Add(20007, 336, 135, 353, 150, texMisc);
	sprites->Add(20008, 354, 135, 371, 150, texMisc);
	...
	brick2 = new CBrick2(150.0f, 100.0f);
	gumpa = new CEnemy(GUMPA_START_X, GUMPA_START_Y, GUMPA_START_VX);
}
